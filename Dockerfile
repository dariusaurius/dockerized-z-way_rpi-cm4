...
RUN apt-get update && apt-get -y dirmngr apt-transport-https
...
RUN apt-get update && apt-get install -o Dpkg::Options::="--force-confmiss" -o Dpkg::Options::="--force-confold" -y z-way-server webif
